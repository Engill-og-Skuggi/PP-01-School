...
class Human:
    """Класс 'Человек', являющийся суперклассом для подклассов Teacher и Student. Определяет основные общие атрибуты (ФИО, id) и методы для оаботы с объектом 'человек' """
    _name: str
    _last_name: str
    _surname: str
    __id: int
